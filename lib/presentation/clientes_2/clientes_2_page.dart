...
import 'package:renta_carros/presentation/clientes_2/historial_clientes_page.dart';

class ClientePage2 extends StatefulWidget {
  const ClientePage2({super.key});

  @override
  State<ClientePage2> createState() => _ClientePage2State();
}

class _ClientePage2State extends State<ClientePage2> {
                          ...
                          onPressed:
                              () => {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder:
                                        (_) => HistorialClientePage(item: item),
                                  ),
                                ),
                              },
                        ),
